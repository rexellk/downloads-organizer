...
// import Link from "next/link"; // Removed for Vite/React setup
...
export default function SelectionBento() {
    ...
    {
        id: "Info",
        title: "Get downloaded files Info",
        description:
            "Tap this bento grid to view all your files in the downloads directory",
        onClick: () => {
        ...
        feature: "textbox",
        size: "lg",
        className: "col-span-3 row-span-1 md:col-span-3 md:row-span-1",
        textboxPlaceholder: files.length > 0 ? files.slice(0, 5).map(file => `${file.name}\n${file.size_mb} MB • .${file.extension} • ${file.age_days} days old`).join('\n\n') + (files.length > 5 ? `\n\n... and ${files.length - 5} more files` : '') : "Click to load files...",
    },
    {
        id: "Candidacy",
        title: "Get Deletion Suggestions",
        description:
...
const TextBoxFeature = ({ placeholder = "Enter your notes or file information here..." }: { placeholder?: string }) => {
    ...
    return (
        <div className="mt-4">
            <textarea
                ...
                readOnly
                className="w-full p-4 rounded-lg bg-neutral-100/80 dark:bg-neutral-800/80 border border-neutral-200/50 dark:border-neutral-700/50 h-[120px] resize-none text-sm text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 dark:focus:ring-emerald-400/50 focus:border-emerald-500/50 dark:focus:border-emerald-400/50 transition-all duration-200 read-only:cursor-default overflow-y-auto whitespace-pre-line"
            />
        </div>
    );
};
            ...
            >
                ...
                >
                    <div className="space-y-2 flex-1 flex flex-col">
                        ...
                        {item.feature === "textbox" && (
                            <TextBoxFeature placeholder={item.textboxPlaceholder} />
                        )}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="grid md:grid-cols-3 gap-6">
                        <motion.div
                            variants={fadeInUp}
                            className={bentoItems[0].className || "md:col-span-1"}
                        >
                            <BentoCard item={bentoItems[0]} />
                        </motion.div>
                        <motion.div
                            variants={fadeInUp}
                            className={bentoItems[1].className || "md:col-span-2"}
                        >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <motion.div
                            variants={fadeInUp}
                            className={bentoItems[2].className || "md:col-span-1"}
                        >
